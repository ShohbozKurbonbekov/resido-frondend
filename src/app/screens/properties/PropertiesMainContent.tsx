...
export default function PropertiesMainContent() {
  return (
    <section className="px-6 pb-3 bg-sky-100">
      <div className="container grid grid-cols-1 md:grid-cols-3 gap-6  px-0 bg-sky-100">
        <div className="hidden md:block md:columns-1 border-2  rounded-sm p-[25px] bg-white">
          <form action="/properties" className="">
            ...
            <button
              type="submit"
              className="w-full bg-blue-700 text-white text-sm font-jostFont text-center rounded-md  py-4 mt-2 hover:bg-blue-500 transition-colors duration-75 ease-linear"
            >
              Search
            </button>
          </form>
        </div>
        <div className="md:col-span-2  bg-white rounded-sm">side 2</div>
      </div>
    </section>
  );
}
