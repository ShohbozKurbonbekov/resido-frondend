...
export default function VideoPlayer() {
  ...
  return (
    <div className="relative w-full h-full max-h-[535px] aspect-video group">
      {/* Video Element */}
      <video
        ref={videoRef}
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button
          onClick={togglePlay}
          className="p-2 bg-black bg-opacity-60 rounded-full text-white hover:bg-opacity-80 transition-all"
