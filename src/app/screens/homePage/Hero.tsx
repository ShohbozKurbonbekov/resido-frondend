export default function Hero() {
  return (
    ...
    "
    >
      <div className="overlay absolute inset-0 bg-[#032137] opacity-60"></div>
      <div className="absolute top-0 left-0 right-0 bottom-0 mt-14  z-30 flex flex-col items-center justify-center text-slate-50 text-center px-4">
        <p className="font-loraFont text-xl italic">
          Find Best Places around South Korea
        </p>
        <h1 className="font-jostFont text-4xl md:text-6xl leading-none text-slate-50 font-bold capitalize  mt-3">
