...
export const defaultPropertyAvatar = "/img/city.png";
...
export const errorClasses = "text-xs text-rose-600/90";
...
export const inputClasses =
  "tracking-wide font-jostFont border-slate-300 bg-slate-50 text-slate-600 placeholder:text-slate-400 focus-visible:ring-2 focus-visible:ring-emerald-600/30 focus-visible:border-emerald-600 text-base sm:text-lg md:text-sm";
